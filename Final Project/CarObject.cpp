...
CarObject::CarObject(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
    _center.x() = center_x;
    _center.y() = center_y;
    _center.z() = center_z;
...
void CarObject::initShader(void)
{
...
void CarObject::setMatrix(glm::mat4& matrix)
{
...
void CarObject::interpolateMat(void)
{
